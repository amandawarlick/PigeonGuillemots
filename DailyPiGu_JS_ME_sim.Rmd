...
n.occasions <- 100              # Number of capture occasions
...
phiA <- 0.97                    # survival state A (egg burrow)
phiB <- 0.98                    # survival state B (chick burrow)
psiAB <- 0.05                   # transition A to B conditional on survival
pA <- 0.4                       # detection for egg burrow
pB <- 0.6                       # detection for chick burrow
beta <- 0.2                     # conditional on observing true state chick, probability obs was bv
