...
# 9. Multievent model
#
# This is the implementation of the model decsribed in Conn & Cooch (2009, J. Apll. Ecol. 46: 486-492)
#
##############################################################

# Created Sept. 2012
# Last up-date: 29.6.2013
library(jagsUI)
library(R2OpenBUGS)
...
# Initial values
inits <- function(){list(mean.phi = runif(2, 0, 1), mean.psi = runif(2, 0, 1), mean.p = runif(2, 0, 1), z = me.init.z(rCH, f))}  
...
# Call jagsUI
me <- jags(jags.data, inits, parameters, "me.bug", n.chains = nc, n.adapt=nAdapt, n.thin = nt, n.iter = ni, n.burnin = nb, parallel=TRUE)
