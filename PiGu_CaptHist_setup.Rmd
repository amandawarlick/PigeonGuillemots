...
burrow <- data_burrow_all %>%
  ...
  #filter(grepl("Totten Elizan A", site) & year == '2016') %>% arrange(study_day)
...
prey_start_end <- burrow %>%
  ...
  #filter(grepl("Totten Elizan A", site) & year == '2016')
...
burrow_day_CH <- burrow_day_CH[!duplicated(burrow_day_CH),] #just two duplicates - living with that
