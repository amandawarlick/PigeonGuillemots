...
for (i in 1:M){
 ...
 for (t in 2:n.occasions){
  ...
  y[i,k] ~ dcat(po[z[i,effort[i,k]], i, k, 1:3]) 
  } #k
} #i
...
#state at entry
# ent.st <- matrix(NA, nrow = n.occasions+1, ncol = n.states)
#  for(t in 1:nrow(ent.st)){
#   ent.st[t,]<- c(0.33, 0.33, 0.33, 0) #multinomial probability of entering into 1-3 states
#  }
...
for (i in 1:Nstar){
   for (t in 1:n.occasions){
      ...
      (1-gamma[t]), gamma[t], 0, 0,   #help, what should this be if nest already entered at occasion 1?
