...
# data_ME_day_wide <- data_ME_day_wide %>%
#   transform(exclude = ifelse())
# 
# data_ME_day_wide[,5:79]
# 
# test1 <- data_ME_day_wide %>%
#   select(-c(region, year, site, burrow_name)) %>%
#   rowSums(.[1:75]) %>%
#   filter(sum >= 225)
...
#   distinct(year, site, burrow_name, week, capt_hist) %>% 
...
which(f > 1000) #101  239  600  604 1452 2162 2283
